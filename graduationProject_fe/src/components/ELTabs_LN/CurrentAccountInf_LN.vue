        ...
        <el-row class="row-bg" justify="space-evenly" style="margin-top:10px">
            <el-col :span="22">
                <el-card shadow="hover">
                    ...
                    <el-row class="rowStyle">
                        <el-col :span="4">
                            <div class="titLeft">账户所属社区</div>
                        </el-col>
                        <el-col :span="20">
                            <div class="neiRong">{{dataValue.communityName}}</div>
                        </el-col>
                    </el-row>
                    <el-row class="rowStyle">
                        <el-col :span="4">
                            <div class="titLeft">账户所属区域</div>
                        </el-col>
                        <el-col :span="20">
                            <div class="neiRong">{{dataValue.areaName}}</div>
                        </el-col>
                    </el-row>
                    <el-row class="rowStyle">
                        <el-col :span="4">
                            <div class="titLeft">账户所属楼组</div>
                        </el-col>
                        <el-col :span="20">
                            <div class="neiRong">{{dataValue.buildName}}</div>
                        </el-col>
                    </el-row>
                    <el-row class="rowStyle">
                        <el-col :span="4">
...
export default {
    setup () {
        ...
        const dataValue = reactive({
            ...
            communityName: sessionStorage.getItem('communityName'), //当前账户所属社区
            areaName: sessionStorage.getItem('areaName'), //当前账户所属区域
            buildName: sessionStorage.getItem('buildName'), //当前账户所属楼组
        })
